    ...
    case 'select': // form_type : select
      return (
        <div key={key} className="flex mb-2.5">
          ...
          >
            <option hidden selected>Select {input.name}</option>
    ...
    <div className={"p-12"}>
      ...
      <div className="bg-gray-100 p-8 rounded">
        ...
        <div className={'flex justify-center mt-6'}>
          <button className={"w-1/5 mx-6 p-2 bg-red-400 text-white font-black text-lg rounded-xl"}>뒤로가기</button>
          <button className={"w-1/5 mx-6 p-2 bg-Cmain text-white font-black text-lg rounded-xl"}>알고리즘 등록</button>
        </div>
